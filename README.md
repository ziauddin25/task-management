...
Vite	Development & Build Tool <br>
...
The task will be added to the selected column. <br>
Updating Task Status <br>
Drag a task card and drop it into another status column. <br>
The task status updates automatically. <br>
Deleting a Task <br>
...
The goal of this project is to provide a simple yet effective task management experience using a Kanban board approach. It demonstrates state management, drag-and-drop interactions, reusable component architecture, and local data persistence in a modern React application. <br>
...
Built with ❤️ using React, Vite, Tailwind CSS, shadcn/ui, and Local Storage. <br>